...
class TestInference(unittest.TestCase):
    def setUp(self):
        ...
        random.seed(37)
        np.random.seed(37)
        np.set_printoptions(precision=10, formatter={"float": lambda v: f"{v:.10f}"})
    ...
    def test_cowell_x(self):
        ...
        assert_almost_equal(
            g.E, [[0.4962114580, 0.0020891582], [0.0020891582, 0.9843995081]]
        )

    def test_cowell_z(self):
        """
        ...
        assert_almost_equal(
            g.E, [[0.6552719951, 0.3226010216], [0.3226010216, 0.6542698781]]
        )

    def test_cowell_y(self):
        """
        ...
        assert_almost_equal(
            g.E, [[1.0099559400, 1.0160891744], [1.0160891744, 2.0066503668]]
        )

    def test_do_inferences(self):
        """
    ...
    def test_repr(self):
        ...
        o = str(g)
        e = (
            "GaussianInference[H=[A,B,C,D], M=[0.002,-0.009,0.007,-0.018], E=[[0.991,0.008,1.001,0.204]|[0.008,1.010,"
        ...
        o = g.marginals
        e = [
            {"name": "A", "mean": -0.0017234068142374496, "var": 0.9907002440358944},
