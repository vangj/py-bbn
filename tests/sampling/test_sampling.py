...
from pybbn.sampling.sampling import LogicSampler, Table
...
class TestSampling(unittest.TestCase):
    ...
    def test_multiple_pa_ch_table(self):
        """
    ...
    def test_toplogical_sort_huang(self):
        """
    ...
    def test_toplogical_sort_reversed(self):
        """
    ...
    def test_toplogical_sort_mixed(self):
        """
    ...
    def test_sampling(self):
        ...
        assert_almost_equal(
            s_a.values,
            np.array([posteriors["a"]["off"], posteriors["a"]["on"]]),
            decimal=1,
        )
        assert_almost_equal(
            s_b.values,
            np.array([posteriors["b"]["off"], posteriors["b"]["on"]]),
            decimal=1,
        )
        assert_almost_equal(
            s_c.values,
            np.array([posteriors["c"]["off"], posteriors["c"]["on"]]),
            decimal=1,
        )

    def test_sampling_with_rejection(self):
        """
        ...
        assert_almost_equal(
            s_b, np.array([posteriors["b"]["off"], posteriors["b"]["on"]]), decimal=1
        )
        assert_almost_equal(
            s_c, np.array([posteriors["c"]["off"], posteriors["c"]["on"]]), decimal=1
        )
